...
class sysSettingCont extends Core\coreController
{
	protected function setup()
	{
		...
		$this->model_name		= "platform\directory\modelsystem\sysSetting";
		$this->view_listing		= 'platform.admin.list.list_sysSetting';
		$this->view_single		= 'platform.admin.single.sysSetting';
