@extends('platform.layout.admin_base_bs3')
...
@endif
@stop 
@include('platform.layout.admin_popup_confirm', array('msg_title' => 'Change Lock Status','msg_body' => 'Are you going to change the lock status?','classname'=>'myModal_Lock','act_url'=>$app_url.'/Admin/setting/'.$resData->id.'/chgLock'))
@include('platform.layout.admin_popup_confirm', array('msg_title' => 'Remove data','msg_body' => 'Are you going to Remove?','classname'=>'myModal_Active','act_url'=>$app_url.'/Admin/setting/'.$resData->id.'/remove'))